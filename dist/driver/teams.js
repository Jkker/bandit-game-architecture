...
const getCmd = (team) => {
    ...
    if (typeof team.target === 'string') {
        const cmd = exeMap[team.exe] + path_1.default.join('bandit-game-agents', name, team.target);
        return {
            casino: cmd,
            player: cmd,
        };
    ...
    return {
        casino: exeMap[team.exe] +
            path_1.default.join('bandit-game-agents', name, team.target.casino),
        player: exeMap[team.exe] +
            path_1.default.join('bandit-game-agents', name, team.target.player),
    };
};
...
if (require.main === module) {
    ...
    console.log((0, exports.getCmd)(team));
}
